  ...
  function applyRequestedCopy() {
    ...
    if (bundleFeatures) {
      bundleFeatures.innerHTML = '<li><span class="plan__check">✓</span><span>책 1권 (약 238페이지)</span></li>' +
        ...
        '<li><span class="plan__check">✓</span><span class="plan__feat-strong">제품 마진 계산기</span></li>' +
